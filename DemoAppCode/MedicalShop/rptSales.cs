	...
	public class rptSales : Form
	{
		...
		private void cmbSearchFor_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			try
			{
				...
				if (this.cmbSearchFor.Text != "")
				{
					...
					{
						this.cmbSearchBy.Visible = true;
						dataTable = this.mastersp.SalesMasterViewAll();
						this.cmbSearchBy.DataSource = dataTable;
		...
		public void fillGrid()
		{
			try
			{
				...
				if (this.cmbSearchFor.Text == "All")
				{
					dataTable = this.mastersp.SalesReportForAll(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text));
				}
				else if (this.cmbSearchFor.Text == "Generic Name")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.SalesReportForGenericName(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Product")
				{
					if (this.cmbSearchBy.Text != "")
					{
						...
						dataTable = this.mastersp.SalesReportForProduct(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Sales Man")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.SalesReportForSalesMan(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Product Group")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.SalesReportForProductGroup(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Voucher No")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.SalesReportForVoucherNo(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Invoice No")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.SalesReportForInvoice(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Cash/Party Account")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.SalesReportForCashAccount(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Doctor")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.SalesReportForDoctor(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Patient")
				{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptSales));
			...
			this.groupBox4.Location = new Point(752, 142);
			...
			this.dgvReport.Location = new Point(12, 223);
			...
			this.groupBox1.Location = new Point(11, 127);
			...
			this.groupBox2.Location = new Point(12, 175);
			...
			this.cmbSearchBy.Location = new Point(258, 12);
			...
			objArray = new object[] { "All", "Generic Name", "Product", "Product Group", "Cash/Party Account", "Invoice No", "Voucher No", "Sales Man", "Patient", "Doctor" };
			objectCollections.AddRange(objArray);
			this.cmbSearchFor.Location = new Point(92, 12);
			...
			this.label4.Location = new Point(13, 18);
