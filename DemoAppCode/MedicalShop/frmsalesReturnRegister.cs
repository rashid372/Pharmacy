...
{
	public class frmsalesReturnRegister : Form
	{
		...
		public void CallPurchaseReturnInvoice()
		{
			if (this.dgvRegister.CurrentRow != null)
			{
				...
				_frmSalesReturn.DoWhenComingFromRegister(this, this.dgvRegister.CurrentRow.Cells[0].Value.ToString());
				base.Enabled = false;
			}
		}
		...
		{
			DataTable dataTable = this.mastersp.SalesReturnMasterViewAllForRegisters(DateTime.Parse(this.dtpFromDate.Text), DateTime.Parse(this.dtpToDate.Text));
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmsalesReturnRegister));
			...
			this.Ledger.HeaderText = "Sales Invoice No";
			...
			this.label1.Text = "Sales Return  Register";
			...
			base.Name = "frmsalesReturnRegister";
