...
{
    public class rptMostRunningProducts : Form
    {
        ...
        private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                this.strHeading = "MOST RUNNING PRODUCTS REPORT";
        ...
        public void FillGrid()
        {
            try
            {
                ...
                dataTable = productSP.MostRunningProductsViewBetweenDates(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text));
                int str = 1;
                ...
                foreach (DataRow row in dataTable.Rows)
                {
                    ...
                    this.dgvReport.Rows[str].Cells["totalSold"].Value = row.ItemArray[3].ToString();
        ...
        private void FillSerachCombo()
            ...
            private void InitializeComponent()
            {
                ...
                ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptMostRunningProducts));
                ...
                this.label5.Text = "Most Running Sale Products";
                ...
                base.Name = "rptMostRunningProducts";
            ...
            public void LoadGridColumns()
            {
                ...
                this.dgvReport.Columns.Add("manufactureName", "manufactureName");
                    ...
                    this.dgvReport.Columns.Add("totalSold", "totalSold");
                ...
                this.dgvReport.Rows.Add();
                    ...
                    this.dgvReport[4, this.dgvReport.Rows.Count - 1].Value = "totalSold";
