...
{
	public class rptSalesReturn : Form
	{
		private SalesReturnMasterSP mastersp = new SalesReturnMasterSP();
		...
		private void bwrk1_DoWork_1(object sender, DoWorkEventArgs e)
		{
			try
			{
				this.strHeading = "SALES RETURN REPORT";
		...
		private void cmbSearchFor_SelectedIndexChanged(object sender, EventArgs e)
		{
			try
			{
				...
				if (this.cmbSearchFor.Text != "")
				{
					...
					{
						this.cmbSearchBy.Visible = true;
						dataTable = salesReturnMasterSP.SalesReturnMasterViewAll();
						if (dataTable.Rows.Count > 0)
						{
							this.cmbSearchBy.DataSource = dataTable;
							this.cmbSearchBy.ValueMember = "SalesReturnMaster Id";
							this.cmbSearchBy.DisplayMember = "SalesReturnMaster Id";
						}
					}
					else
					{
						...
						{
							this.cmbSearchBy.DataSource = dataTable;
							this.cmbSearchBy.ValueMember = "Sales Master Id";
							this.cmbSearchBy.DisplayMember = "Sales Master Id";
						}
					}
					this.fillGrid();
				}
		...
		public void fillGrid()
		{
			try
			{
				...
				this.dgvReport.Columns.Add("1", "Voucher No");
				this.dgvReport.Columns.Add("2", "Invoice No");
				this.dgvReport.Columns.Add("3", "Date");
				this.dgvReport.Columns.Add("4", "Ledger");
				this.dgvReport.Columns.Add("5", "Product");
				this.dgvReport.Columns.Add("6", "Batch");
				this.dgvReport.Columns.Add("7", "Rate");
				this.dgvReport.Columns.Add("8", "Quantity");
				this.dgvReport.Columns.Add("9", "Amount");
				this.dgvReport.Rows.Add();
				this.dgvReport[0, lightSkyBlue].Value = "Sl No";
				this.dgvReport[1, lightSkyBlue].Value = "Voucher No";
				this.dgvReport[2, lightSkyBlue].Value = "Invoice No";
				this.dgvReport[3, lightSkyBlue].Value = "Date";
				this.dgvReport[4, lightSkyBlue].Value = "Ledger";
				this.dgvReport[5, lightSkyBlue].Value = "Product";
				this.dgvReport[6, lightSkyBlue].Value = "Batch";
				this.dgvReport[7, lightSkyBlue].Value = "Rate";
				this.dgvReport[8, lightSkyBlue].Value = "Quantity";
				this.dgvReport[9, lightSkyBlue].Value = "Amount";
				...
				if (this.cmbSearchFor.Text == "All")
				{
					dataTable = this.mastersp.SalesReturnRportForAll(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text));
				}
				else if (this.cmbSearchFor.Text == "Generic Name")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.SalesReturnRportForGenericName(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Product")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.SalesReturnRportForProduct(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Invoice No")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.SalesReturnRportForInvoice(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Product Group")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.SalesReturnRportForProdcutGroup(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Voucher No")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.SalesReturnRportForVoucherNo(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				foreach (DataRow row in dataTable.Rows)
				{
					...
					this.dgvReport.Rows[lightSkyBlue].Cells[2].Value = row.ItemArray[1].ToString();
					DataGridViewCell item = this.dgvReport.Rows[lightSkyBlue].Cells[3];
					DateTime dateTime = DateTime.Parse(row.ItemArray[2].ToString());
					item.Value = dateTime.ToString("dd-MMM-yyyy");
					this.dgvReport.Rows[lightSkyBlue].Cells[4].Value = row.ItemArray[3].ToString();
					this.dgvReport.Rows[lightSkyBlue].Cells[5].Value = row.ItemArray[4].ToString();
					this.dgvReport.Rows[lightSkyBlue].Cells[6].Value = row.ItemArray[5].ToString();
					this.dgvReport.Rows[lightSkyBlue].Cells[7].Value = row.ItemArray[6].ToString();
					this.dgvReport.Rows[lightSkyBlue].Cells[8].Value = row.ItemArray[7].ToString();
					this.dgvReport.Rows[lightSkyBlue].Cells[9].Value = Math.Round(decimal.Parse(row.ItemArray[8].ToString()), 2);
				}
			}
			catch (Exception exception1)
			{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptSalesReturn));
			...
			this.cmbExportType.KeyDown += new KeyEventHandler(this.dtpFrom_KeyDown);
			...
			this.bwrk1.DoWork += new DoWorkEventHandler(this.bwrk1_DoWork_1);
			...
			this.dtpTo.Location = new Point(200, 17);
			...
			this.cmbSearchBy.Location = new Point(284, 13);
			...
			this.cmbSearchBy.KeyDown += new KeyEventHandler(this.dtpFrom_KeyDown);
			...
			objArray = new object[] { "All", "Generic Name", "Product", "Product Group", "Invoice No", "Voucher No" };
			objectCollections.AddRange(objArray);
			this.cmbSearchFor.Location = new Point(92, 13);
			...
			this.cmbSearchFor.KeyDown += new KeyEventHandler(this.dtpFrom_KeyDown);
