...
{
	public class rptDamageStock : Form
	{
		...
		private DamageStcokMasterSP mastersp = new DamageStcokMasterSP();
		...
		private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
		{
			try
			{
				this.strHeading = "DAMAGE STOCK REPORT";
		...
		private void cmbSearchFor_SelectedIndexChanged(object sender, EventArgs e)
		{
			try
			{
				...
				DamageStcokMasterSP damageStcokMasterSP = new DamageStcokMasterSP();
				...
				if (this.cmbSearchFor.Text != "")
				{
					...
					{
						this.cmbSearchBy.Visible = true;
						dataTable = damageStcokMasterSP.DamageStcokMasterViewAll();
						this.cmbSearchBy.DataSource = dataTable;
						this.cmbSearchBy.ValueMember = "Id";
		...
		public void fillGrid()
		{
			try
			{
				...
				if (this.cmbSearchFor.Text == "All")
				{
					dataTable = this.mastersp.DamageStockReportForAll(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text));
				}
				else if (this.cmbSearchFor.Text == "Generic Name")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.DamageStockReportForGenericName(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Product")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.DamageStockReportForProduct(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Product Group")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.DamageStockReportForProductGroup(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Voucher No")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.DamageStockReportForVoucher(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptDamageStock));
			...
			this.groupBox4.Location = new Point(752, 141);
			...
			this.groupBox1.Location = new Point(10, 121);
			...
			this.groupBox2.Location = new Point(11, 171);
			...
			this.cmbSearchBy.Location = new Point(277, 16);
