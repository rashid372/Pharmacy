...
namespace MedicalShop
{
	public class rtpStock : Form
	{
		...
		private void FillLowStockGridAccordingToSearch()
		{
			try
			{
				...
				foreach (DataGridViewRow row in (IEnumerable)this.dgvReport.Rows)
				{
					...
					if (row.Visible)
					{
						if ((!this.cbxPrint.Checked ? false : row.Index != 0))
						{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox2.Location = new Point(14, 169);
		...
		public void LoadGridColumns()
		{
			try
			{
				...
				this.dgvReport.Columns.Add("Stock Min.", "Stock Min.");
				...
				this.dgvReport.Columns[3].Width = 80;
				...
				this.dgvReport[3, this.dgvReport.Rows.Count - 1].Value = "Stock Min.";
