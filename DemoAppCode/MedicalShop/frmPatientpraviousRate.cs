...
{
    public class frmPatientpraviousRate : Form
    {
       ...
       // private Button btnOk;
        ...
        private DataGridViewTextBoxColumn salesInvoiceNo;
        ...
        public frmPatientpraviousRate()
        {
            this.InitializeComponent();
        }
        public frmPatientpraviousRate(string patientid ,string productId)
        {
            this.InitializeComponent();
        ...
        public void FillFinacialYearGrid()
        {
            ...
            dataTable = (new ProductSP()).Patientprevioussalerate(_patientid ,_productId);
            ...
            foreach (DataRow row in dataTable.Rows)
            {
                ...
                this.dgvFinancial.Rows[str].Cells["salesInvoiceNo"].Value = row.ItemArray[0].ToString();
                this.dgvFinancial.Rows[str].Cells["date"].Value = row.ItemArray[1].ToString();
                this.dgvFinancial.Rows[str].Cells["rate"].Value = row.ItemArray[2].ToString();
        ...
        private void InitializeComponent()
        {
           ...
           // this.btnOk = new Button();
            ...
            this.patientid = new DataGridViewTextBoxColumn();

            this.salesInvoiceNo = new DataGridViewTextBoxColumn();
          ...
          //  this.panel1.Controls.Add(this.btnOk);
            ...
            DataGridViewColumn[] d = new DataGridViewColumn[] { this.salesInvoiceNo, this.date, this.rate  };
            columns.AddRange(d);
            ...
            this.patientid.HeaderText = "productId";
            this.productId.Name = "productId";
            this.productId.ReadOnly = true;
            this.productId.Visible = true;
            ...
            this.salesInvoiceNo.Visible = true;
            ...
            this.ID.ReadOnly = true;
            this.ID.Visible = false;
            this.FinacialYear.HeaderText = " Previous Rates ";
            this.FinacialYear.Name = "Previous Rates";
            ...
            this.label1.Text = " Previous Rates";
            ...
            base.Name = "frmPatientpraviousRate";
            base.Padding = new System.Windows.Forms.Padding(7);
            base.StartPosition = FormStartPosition.CenterScreen;
            this.Text = " Previous Rates";
