...
{
	public class frmPurchaseRegister : Form
	{
		...
		public void CallPurchaseInvoice()
		{
			if (this.dgvRegister.CurrentRow != null)
			{
				...
				_frmPurchaseInvoice.DoWhenComingFromRegister(this, this.dgvRegister.CurrentRow.Cells[0].Value.ToString());
				base.Enabled = false;
			}
		}
		...
		{
			DataTable dataTable = this.mastersp.PurchaseMAsterViewAllForRegister(DateTime.Parse(this.dtpFromDate.Text), DateTime.Parse(this.dtpToDate.Text));
			...
			foreach (DataRow row in dataTable.Rows)
			{
				...
				dataTable1 = purchaseDetailsSP.PurchaseDetailsViewAllByMasterId(row.ItemArray[0].ToString());
				foreach (DataRow dataRow in dataTable1.Rows)
				{
					decimal num1 = decimal.Parse(dataRow.ItemArray[3].ToString());
					decimal num2 = decimal.Parse(dataRow.ItemArray[5].ToString());
					decimal num3 = decimal.Parse(dataRow.ItemArray[4].ToString());
					decimal num4 = decimal.Parse(dataRow.ItemArray[7].ToString());
					num = (!(dataRow.ItemArray[8].ToString() == "True") ? num + ((num1 * num2) - (((num1 * num2) * num3) / new decimal(100))) : (num + ((num1 * num2) - (((num1 * num2) * num3) / new decimal(100)))) + ((((num1 * num2) - (((num1 * num2) * num3) / new decimal(100))) * num4) / new decimal(100)));
				}
				num = (num - decimal.Parse(row.ItemArray[4].ToString())) + decimal.Parse(row.ItemArray[5].ToString());
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmPurchaseRegister));
