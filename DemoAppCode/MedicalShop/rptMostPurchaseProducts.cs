...
{
    public class rptMostPurchaseProducts: Form
    {
        ...
        public rptMostPurchaseProducts()
        {
        ...
        private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                this.strHeading = "MOST RUNNING PURCHASE PRODUCTS REPORT";
        ...
        public void FillGrid()
        {
            try
            {
                ...
                dataTable = productSP.MostRunningPurchaseProductsViewBetweenDates(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text));
                int str = 1;
                ...
                foreach (DataRow row in dataTable.Rows)
                {
                    ...
                    this.dgvReport.Rows[str].Cells["productId"].Value = row.ItemArray[0].ToString();
                    this.dgvReport.Rows[str].Cells["manufactureName"].Value = row.ItemArray[2].ToString();
                    this.dgvReport.Rows[str].Cells["productName"].Value = row.ItemArray[1].ToString();
                    this.dgvReport.Rows[str].Cells["totalPurchased"].Value = row.ItemArray[3].ToString();
        ...
        private void FillGridAccordingToSearch()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (this.cmbSearchFor.SelectedIndex > -1)
                    {
        ...
        private void FillSerachCombo()
            ...
            private void InitializeComponent()
            {
                ...
                ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptMostPurchaseProducts));
                ...
                this.label5.Text = "Most Purchase Products";
                ...
                this.cmbSearchFor.Location = new Point(279, 14);
                ...
                objArray = new object[] { "All","Product" };
                ...
                this.lblSearc.Location = new Point(6, 17);
                ...
                this.dtpTo.ValueChanged += new EventHandler(this.cmbSearch_SelectedIndexChanged);
                ...
                base.Name = "rptMostPurchaseProducts";
            ...
            public void LoadGridColumns()
            {
                ...
                this.dgvReport.Columns.Add("totalPurchased", "totalPurchased");

                  
                    this.dgvReport.Columns[0].Width = 50;
                this.dgvReport.Columns[1].Width = 50;
                this.dgvReport.Columns[2].Width = 70;
                this.dgvReport.Columns[3].Width = 90;
                this.dgvReport.Columns[4].Width = 100;

                this.dgvReport.Rows.Add();
                    this.dgvReport.Rows[0].Frozen = true;
                    this.dgvReport[0, this.dgvReport.Rows.Count - 1].Value = "Sl No";
                    this.dgvReport[1, this.dgvReport.Rows.Count - 1].Value = "productId";
                    this.dgvReport[3, this.dgvReport.Rows.Count - 1].Value = "manufactureName";
                    this.dgvReport[2, this.dgvReport.Rows.Count - 1].Value = "productName";
                    this.dgvReport[4, this.dgvReport.Rows.Count - 1].Value = "totalPurchased";
