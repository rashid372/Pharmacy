...
{
	public class rptProfitAndLossAnalysis : Form
	{
		...
		public rptProfitAndLossAnalysis()
		{
		...
		public void FillGrid()
		{
			...
			if (!this.rbtnContensed.Checked)
			{
				...
				dataSet = accountLedgerSP.DetailedProfitAndLossAnalysis(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), true);
				dataTable = dataSet.Tables[0];
				this.dgvReport.Rows.Add();
				num = new decimal(0);
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[0].Value = "Opening Stock";
				if (dataTable.Rows.Count > 0)
				{
					foreach (DataRow row1 in dataTable.Rows)
					{
						num = num + decimal.Parse(row1.ItemArray[0].ToString().ToString());
					}
				}
				num = Math.Round(num, 2);
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[1].Value = num.ToString();
				...
				if (dataTable.Rows.Count > 0)
				{
					...
					{
						num1 = num1 + decimal.Parse(dataRow.ItemArray[0].ToString().ToString());
					}
				}
				num1 = Math.Round(num1, 2);
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = num1.ToString();
				this.dgvReport.Rows.Add();
				this.dgvReport.Rows.Add();
				int count = this.dgvReport.Rows.Count - 1;
				num2 = new decimal(0);
				dataTable = new DataTable();
				dataTable = dataSet.Tables[1];
				this.dgvReport.Rows[count].Cells[0].Value = "Purchase Account";
				this.dgvReport.Rows[count].DefaultCellStyle.Font = font;
				if (dataTable.Rows.Count > 0)
				{
					foreach (DataRow row1 in dataTable.Rows)
					{
						this.dgvReport.Rows.Add();
						this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[0].Value = string.Concat("    ", row1.ItemArray[0].ToString());
						this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[1].Value = row1.ItemArray[1].ToString();
						num3 = decimal.Parse(row1["Debit"].ToString().ToString());
						num2 = num2 + num3;
					}
				}
				num2 = Math.Round(num2, 2);
				this.dgvReport.Rows[count].Cells[1].Value = num2.ToString();
				if (num2 == new decimal(0))
				{
					this.dgvReport.Rows[count].Cells[1].Value = "0.00";
				}
				dataTable = new DataTable();
				dataTable = dataSet.Tables[2];
				this.dgvReport.Rows[count].Cells[2].Value = "Sales Account";
				int str = count;
				count++;
				num4 = new decimal(0);
				if (dataTable.Rows.Count > 0)
				{
					...
					{
						if (count >= this.dgvReport.Rows.Count)
						{
							this.dgvReport.Rows.Add();
							this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[2].Value = string.Concat("    ", dataRow1.ItemArray[0].ToString());
							this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = dataRow1.ItemArray[1].ToString();
						}
						else
						{
							this.dgvReport.Rows[count].Cells[2].Value = string.Concat("    ", dataRow1.ItemArray[0].ToString());
							this.dgvReport.Rows[count].Cells[3].Value = dataRow1.ItemArray[1].ToString();
						}
						num3 = decimal.Parse(dataRow1["Credit"].ToString().ToString());
						num4 = num4 + num3;
						count++;
					}
				}
				num4 = Math.Round(num4, 2);
				this.dgvReport.Rows[str].Cells[3].Value = num4.ToString();
				if (num4 == new decimal(0))
				{
					this.dgvReport.Rows[str].Cells[3].Value = "0.00";
				}
				this.dgvReport.Rows.Add();
				this.dgvReport.Rows.Add();
				dataTable = new DataTable();
				dataTable = dataSet.Tables[3];
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[0].Value = "Direct Expense";
				count = this.dgvReport.Rows.Count - 1;
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].DefaultCellStyle.Font = font;
				num5 = new decimal(0);
				if (dataTable.Rows.Count > 0)
				{
					...
					{
						this.dgvReport.Rows.Add();
						this.dgvReport.Rows[count].Cells[0].Value = string.Concat("    ", row2.ItemArray[0].ToString());
						this.dgvReport.Rows[count].Cells[1].Value = row2.ItemArray[1].ToString();
						num3 = decimal.Parse(row2["Debit"].ToString().ToString());
						num5 = num5 + num3;
					}
				}
				num5 = Math.Round(num5, 2);
				this.dgvReport.Rows[count].Cells[1].Value = num5.ToString();
				...
				this.dgvReport.Rows[count].Cells[2].Value = "Direct Income";
				int str1 = count;
				count++;
				num6 = new decimal(0);
				if (dataTable.Rows.Count > 0)
				{
					foreach (DataRow dataRow2 in dataTable.Rows)
					{
						...
						{
							this.dgvReport.Rows.Add();
							this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[2].Value = string.Concat("    ", dataRow2.ItemArray[0].ToString());
							this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = dataRow2.ItemArray[1].ToString();
						}
						else
						{
							this.dgvReport.Rows[count].Cells[2].Value = string.Concat("    ", dataRow2.ItemArray[0].ToString());
							this.dgvReport.Rows[count].Cells[3].Value = dataRow2.ItemArray[1].ToString();
						}
						num3 = decimal.Parse(dataRow2["Credit"].ToString().ToString());
						num6 = num6 + num3;
						count++;
					}
				}
				num6 = Math.Round(num6, 2);
				this.dgvReport.Rows[str1].Cells[3].Value = num6.ToString();
				if (num6 == new decimal(0))
				{
					this.dgvReport.Rows[str1].Cells[3].Value = "0.00";
				}
				this.dgvReport.Rows.Add();
				this.dgvReport.Rows.Add();
				this.dgvReport.Rows.Add();
				...
				if (!(num7 > num8))
				{
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[1].Value = num8.ToString();
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = num8.ToString();
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].Cells[0].Value = "Gross Profit c/d ";
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].Cells[1].Value = num8 - num7;
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].Cells[1].Style.ForeColor = Color.Green;
					this.dgvReport.Rows.Add();
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[2].Value = "Gross Profit c/d ";
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = num8 - num7;
					num9 = num8 - num7;
				}
				else
				{
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[1].Value = num7.ToString();
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = num7.ToString();
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].Cells[2].Value = "Gross Loss b/d ";
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].Cells[3].Value = num7 - num8;
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].Cells[3].Style.ForeColor = Color.Red;
					this.dgvReport.Rows.Add();
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[0].Value = "Gross Loss b/d ";
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[1].Value = num7 - num8;
					num10 = num7 - num8;
				}
				this.dgvReport.Rows.Add();
				this.dgvReport.Rows.Add();
				...
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[0].Value = "Indirect Expense";
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].DefaultCellStyle.Font = font;
				count = this.dgvReport.Rows.Count - 1;
				num11 = new decimal(0);
				if (dataTable.Rows.Count > 0)
				{
					...
					{
						this.dgvReport.Rows.Add();
						this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[0].Value = string.Concat("    ", row3.ItemArray[0].ToString());
						this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[1].Value = row3.ItemArray[1].ToString();
						num3 = decimal.Parse(row3["Debit"].ToString().ToString());
						num11 = num11 + num3;
					}
				}
				num11 = Math.Round(num11, 2);
				this.dgvReport.Rows[count].Cells[1].Value = num11.ToString();
				...
				this.dgvReport.Rows[count].Cells[2].Value = "Indirect Income";
				str1 = count;
				count++;
				num12 = new decimal(0);
				if (dataTable.Rows.Count > 0)
				{
					foreach (DataRow dataRow3 in dataTable.Rows)
					{
						...
						{
							this.dgvReport.Rows.Add();
							this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[2].Value = string.Concat("    ", dataRow3.ItemArray[0].ToString());
							this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = dataRow3.ItemArray[1].ToString();
						}
						else
						{
							this.dgvReport.Rows[count].Cells[2].Value = string.Concat("    ", dataRow3.ItemArray[0].ToString());
							this.dgvReport.Rows[count].Cells[3].Value = dataRow3.ItemArray[1].ToString();
						}
						num3 = decimal.Parse(dataRow3["Credit"].ToString().ToString());
						num12 = num12 + num3;
						count++;
					}
				}
				num12 = Math.Round(num12, 2);
				this.dgvReport.Rows[str1].Cells[3].Value = num12.ToString();
				...
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = "_______________________";
				this.dgvReport.Rows.Add();
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[0].Value = "Grand Total";
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[2].Value = "Grand Total";
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].DefaultCellStyle.Font = font;
				if (!(num13 > num14))
				{
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[1].Value = num14.ToString();
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = num14.ToString();
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].Cells[0].Value = "Net Profit";
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].Cells[1].Value = num14 - num13;
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].Cells[0].Style.ForeColor = Color.Green;
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].Cells[1].Style.ForeColor = Color.Green;
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].DefaultCellStyle.Font = font;
				}
				else
				{
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[1].Value = num13.ToString();
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = num13.ToString();
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].Cells[2].Value = "Net Loss ";
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].Cells[3].Value = num13 - num14;
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].Cells[2].Style.ForeColor = Color.Red;
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].Cells[3].Style.ForeColor = Color.Red;
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 3].DefaultCellStyle.Font = font;
				}
			}
			else
			{
				...
				if (dataTable.Rows.Count > 0)
				{
					...
					{
						num = num + decimal.Parse(row4.ItemArray[0].ToString().ToString());
					}
				}
				num = Math.Round(num, 2);
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[1].Value = num.ToString();
				...
				if (dataTable.Rows.Count > 0)
				{
					...
					{
						num1 = num1 + decimal.Parse(dataRow4.ItemArray[0].ToString().ToString());
					}
				}
				num1 = Math.Round(num1, 2);
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = num1.ToString();
				...
				dataTable = dataSet.Tables[1];
				this.dgvReport.Rows.Add();
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[0].Value = "Purchase Account";
				num2 = new decimal(0);
				if (dataTable.Rows.Count > 0)
				{
					foreach (DataRow row5 in dataTable.Rows)
					{
						num3 = decimal.Parse(row5["Debit"].ToString().ToString());
						num2 = num2 + num3;
					}
				}
				num2 = Math.Round(num2, 2);
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[1].Value = num2.ToString();
				if (num2 == new decimal(0))
				{
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[1].Value = "0.00";
				}
				dataTable = new DataTable();
				dataTable = dataSet.Tables[2];
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[2].Value = "Sales Account";
				num4 = new decimal(0);
				if (dataTable.Rows.Count > 0)
				{
					foreach (DataRow dataRow5 in dataTable.Rows)
					{
						num3 = decimal.Parse(dataRow5["Credit"].ToString().ToString());
						num4 = num4 + num3;
					}
				}
				num4 = Math.Round(num4, 2);
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = num4.ToString();
				if (num4 == new decimal(0))
				{
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = "0.00";
				}
				this.dgvReport.Rows.Add();
				this.dgvReport.Rows.Add();
				dataTable = new DataTable();
				...
				if (dataTable.Rows.Count > 0)
				{
					...
					{
						num3 = decimal.Parse(row6["Debit"].ToString().ToString());
						num5 = num5 + num3;
					}
				}
				num5 = Math.Round(num5, 2);
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[1].Value = num5.ToString();
				if (num5 == new decimal(0))
				{
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[1].Value = "0.00";
				}
				dataTable = new DataTable();
				dataTable = dataSet.Tables[4];
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[2].Value = "Direct Income";
				num6 = new decimal(0);
				if (dataTable.Rows.Count > 0)
				{
					foreach (DataRow dataRow6 in dataTable.Rows)
					{
						num3 = decimal.Parse(dataRow6["Credit"].ToString().ToString());
						num6 = num6 + num3;
					}
				}
				num6 = Math.Round(num6, 2);
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = num6.ToString();
				if (num6 == new decimal(0))
				{
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = "0.00";
				}
				...
				if (dataTable.Rows.Count > 0)
				{
					...
					{
						num3 = decimal.Parse(row7["Debit"].ToString().ToString());
						num11 = num11 + num3;
					}
				}
				num11 = Math.Round(num11, 2);
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[1].Value = num11.ToString();
				if (num11 == new decimal(0))
				{
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[1].Value = "0.00";
				}
				dataTable = new DataTable();
				dataTable = dataSet.Tables[6];
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[2].Value = "Indirect Income";
				num12 = new decimal(0);
				if (dataTable.Rows.Count > 0)
				{
					foreach (DataRow dataRow7 in dataTable.Rows)
					{
						num3 = decimal.Parse(dataRow7["Credit"].ToString().ToString());
						num12 = num12 + num3;
					}
				}
				num12 = Math.Round(num12, 2);
				this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = num12.ToString();
				if (num12 == new decimal(0))
				{
					this.dgvReport.Rows[this.dgvReport.Rows.Count - 1].Cells[3].Value = "0.00";
				}
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptProfitAndLossAnalysis));
			...
			this.label5.Text = "Profit And Loss Analysis";
			...
			this.rbtnContensed.Location = new Point(430, 14);
			...
			this.rbtnDetailed.Location = new Point(552, 16);
			...
			base.Name = "rptProfitAndLossAnalysis";
