...
{
	public class rptDailyCustomer : Form
	{
		...
		private void btnClear_Click(object sender, EventArgs e)
		{
			try
			{
				this.rptManufacture_Load(sender, e);
			}
		...
		private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
		{
			try
			{
				this.strHeading = "DAILY CUSTOMER REPORT";
		...
		public void FillGridDetails()
		{
			...
			try
			{
				...
				dataTable = patientSP.PatientViewAllByStatus(true);
				...
				foreach (DataRow dataRow in dataTable.Rows)
				{
					...
					this.dgvReport[1, this.dgvReport.Rows.Count - 1].Value = dataRow.ItemArray[1].ToString();
					string str1 = dataRow.ItemArray[2].ToString();
					string[] strArrays = Regex.Split(str1, "\r\n");
					string str2 = "";
					string[] strArrays1 = strArrays;
					for (i = 0; i < (int)strArrays1.Length; i++)
					{
						str2 = string.Concat(str2, strArrays1[i], "  ");
					}
					if (!(str2 == " , "))
					{
						length = str2.Length;
						str = str2.Substring(0, length - 2);
						this.dgvReport[2, this.dgvReport.Rows.Count - 1].Value = str;
					}
					else
					{
						this.dgvReport[2, this.dgvReport.Rows.Count - 1].Value = "";
					}
					this.dgvReport[3, this.dgvReport.Rows.Count - 1].Value = dataRow.ItemArray[4].ToString();
					string str3 = dataRow.ItemArray[5].ToString();
					string[] strArrays2 = Regex.Split(str3, "\r\n");
					string str4 = "";
					strArrays1 = strArrays2;
					for (i = 0; i < (int)strArrays1.Length; i++)
					{
						str4 = string.Concat(str4, strArrays1[i], "  ");
					}
					if (!(str4 == " , "))
					{
						length = str4.Length;
						str = str4.Substring(0, length - 2);
						this.dgvReport[4, this.dgvReport.Rows.Count - 1].Value = str;
					}
					else
					{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptDailyCustomer));
			...
			this.label5.Text = "Daily Customer";
			...
			base.Name = "rptDailyCustomer";
			base.StartPosition = FormStartPosition.CenterScreen;
			base.WindowState = FormWindowState.Maximized;
			base.KeyPress += new KeyPressEventHandler(this.rptManufacture_KeyPress);
			base.Load += new EventHandler(this.rptManufacture_Load);
		...
		public void LoadGridColumns()
		{
			try
			{
				...
				this.dgvReport.Columns.Add("Name", "Name");
				...
				this.dgvReport[1, this.dgvReport.Rows.Count - 1].Value = "Name";
		...
		private void rptManufacture_KeyPress(object sender, KeyPressEventArgs e)
		{
			try
			{
				if (e.KeyChar == '\u001B')
		...
		private void rptManufacture_Load(object sender, EventArgs e)
		{
			try
			{
