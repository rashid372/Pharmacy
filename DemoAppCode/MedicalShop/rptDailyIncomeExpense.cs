...
{
	public class rptDailyIncomeExpense : Form
	{
        ...
        public void FillGrid()
        {
            ...
            dataTable = accountLedgerSP.DailyIncomeExpenseView(DateTime.Parse(this.dtpFrom.Text));
            int str = 1;
            ...
            foreach (DataRow row in dataTable.Rows)
            {
                ...
                this.dgvReport.Rows[str].Cells["SaleInvoice"].Value = row.ItemArray[2].ToString();
                this.dgvReport.Rows[str].Cells["TotalSale"].Value = row.ItemArray[3].ToString();
                this.dgvReport.Rows[str].Cells["PurchaseInvoice"].Value = row.ItemArray[4].ToString();
                this.dgvReport.Rows[str].Cells["CashInHand"].Value = row.ItemArray[5].ToString();
        ...
        private void InitializeComponent()
        {
            ...
            ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptDailyIncomeExpense));
            ...
            object[] objArray = new object[] { "All", "Date"};
            ...
            base.Name = "rptDailyIncomeExpense";
        ...
        public void LoadGridColumns()
        {
            try
            {
                ...
                this.dgvReport.Columns.Add("SaleInvoice", "SaleInvoice");
                this.dgvReport.Columns.Add("TotalSale", "TotalSale");
                this.dgvReport.Columns.Add("PurchaseInvoice", "PurchaseInvoice");
                ...
                this.dgvReport[3, this.dgvReport.Rows.Count - 1].Value = "SaleInvoice";
                this.dgvReport[4, this.dgvReport.Rows.Count - 1].Value = "TotalSale";
                
                this.dgvReport[5, this.dgvReport.Rows.Count - 1].Value = "PurchaseInvoice";
                this.dgvReport[6, this.dgvReport.Rows.Count - 1].Value = "CashInHand";
