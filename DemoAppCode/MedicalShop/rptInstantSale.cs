...
{
	public class rptInstantSale : Form
	{
		...
		private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
		{
			try
			{
				this.strHeading = "COUNTER SALE REPORT";
		...
		private void cmbSearchFor_SelectedIndexChanged(object sender, EventArgs e)
		{
			try
			{
				...
				CounterSaleMasterSP counterSaleMasterSP = new CounterSaleMasterSP();
				...
				if (this.cmbSearchFor.Text != "")
				{
					...
					else if (this.cmbSearchFor.Text == "Generic Name")
					{
						...
						this.lblSearchBy.Text = "Generic Name:";
					}
					...
					else if (this.cmbSearchFor.Text == "Product Group")
					{
						...
						this.lblSearchBy.Text = "Product Group:";
					}
					else if (this.cmbSearchFor.Text == "Invoice No")
					{
						...
						this.cmbSearchBy.Visible = true;
						this.lblSearchBy.Visible = true;
						dataTable = salesMasterSP.SalesMasterViewAll();
						this.cmbSearchBy.DataSource = dataTable;
						this.cmbSearchBy.ValueMember = "Sales Invoice No";
						this.cmbSearchBy.DisplayMember = "Sales Invoice No";
						this.lblSearchBy.Text = "Invoice No";
					}
					else if (this.cmbSearchFor.Text == "Doctor")
					{
						...
						this.cmbSearchBy.ValueMember = "ID";
						this.cmbSearchBy.DisplayMember = "Name";
						this.lblSearchBy.Text = "Doctor";
					}
					else if (this.cmbSearchFor.Text == "Patient")
					{
						...
						this.cmbSearchBy.ValueMember = "ID";
						this.cmbSearchBy.DisplayMember = "Name";
						this.lblSearchBy.Text = "Patient";
					}
					else if (this.cmbSearchFor.Text == "Sales Man")
					{
						SalesManSP salesManSP = new SalesManSP();
						this.cmbSearchBy.Visible = true;
						this.lblSearchBy.Visible = true;
						dataTable = salesManSP.SalesManViewAll();
						this.cmbSearchBy.DataSource = dataTable;
						this.cmbSearchBy.ValueMember = "Sales Man Id";
						this.cmbSearchBy.DisplayMember = "Sales Man Name";
						this.lblSearchBy.Text = "Sales Man";
					}
					this.fillGrid();
				}
			}
		...
		public void fillGrid()
		{
			try
			{
				...
				this.dgvReport.Columns.Add("3", "Product");
				this.dgvReport.Columns.Add("4", "Batch");
				this.dgvReport.Columns.Add("5", "Rate");
				this.dgvReport.Columns.Add("6", "Quantity");
				this.dgvReport.Columns.Add("7", "Amount");
				...
				this.dgvReport[3, lightSkyBlue].Value = "Product";
				this.dgvReport[4, lightSkyBlue].Value = "Batch";
				this.dgvReport[5, lightSkyBlue].Value = "Rate";
				this.dgvReport[6, lightSkyBlue].Value = "Quantity";
				this.dgvReport[7, lightSkyBlue].Value = "Amount";
				...
				if (this.cmbSearchFor.Text == "All")
				{
					dataTable = this.mastersp.InstantReportForAll(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text));
				}
				else if (this.cmbSearchFor.Text == "Generic Name")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.InstantReportForGenericName(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Product")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.InstantReportForProduct(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Product Group")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.InstantReportForProductGroup(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Invoice No")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.InstantReportForInvoiceNo(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Patient")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.InstantReportForPaient(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Salse Man")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.InstantReportForSalesMan(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Doctor")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.InstantReportForDoctor(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				foreach (DataRow row in dataTable.Rows)
				{
					...
					this.dgvReport.Rows[lightSkyBlue].Cells[4].Value = row.ItemArray[3].ToString();
					this.dgvReport.Rows[lightSkyBlue].Cells[5].Value = row.ItemArray[5].ToString();
					this.dgvReport.Rows[lightSkyBlue].Cells[6].Value = row.ItemArray[4].ToString();
					decimal num1 = new decimal(0);
					decimal num2 = decimal.Parse(row.ItemArray[5].ToString());
					decimal num3 = decimal.Parse(row.ItemArray[4].ToString());
					num1 = num2 * num3;
					num1 = Math.Round(num1, 2);
					this.dgvReport.Rows[lightSkyBlue].Cells[7].Value = num1.ToString();
				}
			}
			catch (Exception exception1)
			{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptInstantSale));
			...
			this.btnClear.Location = new Point(12, 95);
			...
			this.groupBox4.Location = new Point(752, 148);
			...
			this.label2.Location = new Point(170, 21);
			...
			this.groupBox1.Location = new Point(12, 128);
			...
			this.dtpTo.Location = new Point(203, 17);
			...
			this.lblSearchBy.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f, FontStyle.Bold, GraphicsUnit.Point, 0);
			this.lblSearchBy.Location = new Point(211, 27);
			this.lblSearchBy.Name = "lblSearchBy";
			this.lblSearchBy.Size = new System.Drawing.Size(73, 13);
			this.lblSearchBy.TabIndex = 19;
			this.lblSearchBy.Text = "Search For:";
			this.lblSearchBy.Click += new EventHandler(this.lblSearchBy_Click);
			this.label4.AutoSize = true;
			this.label4.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f, FontStyle.Bold, GraphicsUnit.Point, 0);
			this.label4.Location = new Point(13, 27);
			...
			this.groupBox3.Controls.Add(this.cmbSearchFor);
			this.groupBox3.Controls.Add(this.label6);
			this.groupBox3.Location = new Point(12, 177);
			this.groupBox3.Name = "groupBox3";
			this.groupBox3.Size = new System.Drawing.Size(734, 42);
			this.groupBox3.TabIndex = 21;
			this.groupBox3.TabStop = false;
			this.cmbSearchBy.DropDownStyle = ComboBoxStyle.DropDownList;
			this.cmbSearchBy.FormattingEnabled = true;
			this.cmbSearchBy.Location = new Point(267, 17);
			...
			objArray = new object[] { "All", "Generic Name", "Product", "Product Group", "Invoice No", "Patient", "Doctor", "Sales Man" };
			...
			this.label6.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f, FontStyle.Regular, GraphicsUnit.Point, 0);
