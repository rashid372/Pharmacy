...
{
	public class frmReceiptRegister : Form
	{
		...
		private DataGridViewTextBoxColumn Ledger;
		...
		public void CallPaymentVocuher()
		{
			if (this.dgvRegister.CurrentRow != null)
			{
				...
				_frmReceipt.DoWhenComingFromRegister(this, this.dgvRegister.CurrentRow.Cells[0].Value.ToString());
				base.Enabled = false;
			}
		}
		...
		public void DoWhenComingFromReceipt()
		{
			base.Enabled = true;
			this.FillRegister();
		...
		public void FillRegister()
		{
			...
			{
				str = (!this.rbtnCash.Checked ? "By Cheque" : "By Cash");
			}
			else
			{
				str = "All";
			}
			DataTable dataTable = this.mastersp.RceiptMasterViewAllByCondition(DateTime.Parse(this.dtpFromDate.Text), DateTime.Parse(this.dtpToDate.Text), str);
			this.dgvRegister.Rows.Clear();
			int num = 0;
			foreach (DataRow row in dataTable.Rows)
			{
				this.dgvRegister.Rows.Add();
				this.dgvRegister.Rows[num].Cells[0].Value = row.ItemArray[0].ToString();
				this.dgvRegister.Rows[num].Cells[1].Value = row.ItemArray[2].ToString();
				this.dgvRegister.Rows[num].Cells[2].Value = row.ItemArray[5].ToString();
				this.dgvRegister.Rows[num].Cells[3].Value = row.ItemArray[1].ToString();
				num++;
			}
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmReceiptRegister));
			...
			this.Ledger = new DataGridViewTextBoxColumn();
			...
			this.btnRefresh.Click += new EventHandler(this.frmReceiptRegister_Load);
			...
			this.panel8.Controls.Add(this.rbtnAll);
			...
			DataGridViewColumn[] voucherNo = new DataGridViewColumn[] { this.VoucherNo, this.Ledger, this.Amount, this.Date };
			...
			this.Ledger.HeaderText = "Received From";
			this.Ledger.Name = "Ledger";
			this.Ledger.ReadOnly = true;
			this.Ledger.SortMode = DataGridViewColumnSortMode.NotSortable;
			this.Amount.HeaderText = "Amount";
			this.Amount.Name = "Amount";
			this.Amount.ReadOnly = true;
			this.Amount.SortMode = DataGridViewColumnSortMode.NotSortable;
			this.Date.HeaderText = "Date";
			this.Date.Name = "Date";
			this.Date.ReadOnly = true;
			this.Date.SortMode = DataGridViewColumnSortMode.NotSortable;
			this.txtSearch.Location = new Point(315, 35);
			...
			this.label4.Location = new Point(186, 42);
			this.label4.Name = "label4";
			this.label4.Size = new System.Drawing.Size(123, 13);
			this.label4.TabIndex = 53;
			this.label4.Text = "Search Account Ledger:";
			this.rbtnChecque.AutoSize = true;
			this.rbtnChecque.Location = new Point(301, 12);
			this.rbtnChecque.Name = "rbtnChecque";
			this.rbtnChecque.Size = new System.Drawing.Size(77, 17);
			this.rbtnChecque.TabIndex = 52;
			...
			this.label1.Text = "Receipt Register";
			...
			base.Name = "frmReceiptRegister";
			base.Padding = new System.Windows.Forms.Padding(7);
			base.StartPosition = FormStartPosition.CenterScreen;
			this.Text = "Receipt Register";
			base.Load += new EventHandler(this.frmReceiptRegister_Load);
