	...
	public class rtpDoctor : Form
	{
		...
		public void dgvReportFill()
		{
			try
			{
				...
				foreach (DataRow row in this.DoctorSP.DoctorViewAllExceptNA().Rows)
				{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rtpDoctor));
		...
		public void LoadGridColumns()
		{
			try
			{
				...
				this.dgvReport.Columns.Add("Doctor name", "Doctor name");
				...
				this.dgvReport[1, this.dgvReport.Rows.Count - 1].Value = "Doctor Name";
