...
{
	public class rptStockEtry : Form
	{
		...
		private StockMasterSP mastersp = new StockMasterSP();
		...
		private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
		{
			try
			{
				this.strHeading = " STOCK ENTRY REPORT";
		...
		private void cmbSearchFor_SelectedIndexChanged(object sender, EventArgs e)
		{
			try
			{
				...
				StockMasterSP stockMasterSP = new StockMasterSP();
				...
				if (this.cmbSearchFor.Text != "")
				{
					...
					{
						this.cmbSearchBy.Visible = true;
						dataTable = stockMasterSP.StockMasterViewAll();
						if (dataTable.Rows.Count > 0)
						{
							this.cmbSearchBy.DataSource = dataTable;
							this.cmbSearchBy.ValueMember = "Stock Master Id";
							this.cmbSearchBy.DisplayMember = "Stock Master Id";
						}
					}
					this.fillGrid();
				}
		...
		public void fillGrid()
		{
			try
			{
				...
				if (this.cmbSearchFor.Text == "All")
				{
					dataTable = this.mastersp.StockMasterReportForAll(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text));
				}
				else if (this.cmbSearchFor.Text == "Generic Name")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.StockMasterReportForGenericName(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Product")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.StockMasterReportForProduct(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Product Group")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.StockMasterReportForProductGroup(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Voucher No")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.StockMasterReportForVoucher(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptStockEtry));
			...
			this.groupBox4.Location = new Point(752, 146);
			...
			this.cmbSearchBy.Location = new Point(282, 15);
			...
			this.cmbSearchFor.Location = new Point(92, 15);
			...
			this.label4.Location = new Point(13, 21);
