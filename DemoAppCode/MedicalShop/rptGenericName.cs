...
{
	public class rptGenericName : Form
	{
		...
		private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
		{
			try
			{
				this.strHeading = "GENERIC NAME REPORT";
		...
		public void dgvReportFill()
		{
			try
			{
				...
				foreach (DataRow row in this.GenericNameSP.GenericNameViewAll().Rows)
				{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptGenericName));
			...
			base.Name = "rptGenericName";
			base.StartPosition = FormStartPosition.CenterScreen;
			base.WindowState = FormWindowState.Maximized;
			base.KeyPress += new KeyPressEventHandler(this.rptGenericName_KeyPress);
		...
		public void LoadGridColumns()
		{
			try
			{
				...
				this.dgvReport[1, this.dgvReport.Rows.Count - 1].Value = "Generic Name";
		...
		private void rptGenericName_KeyPress(object sender, KeyPressEventArgs e)
		{
			try
			{
				if (e.KeyChar == '\u001B')
