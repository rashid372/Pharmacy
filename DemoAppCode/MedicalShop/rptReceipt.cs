...
namespace MedicalShop
{
	public class rptReceipt : Form
	{
		...
		private RadioButton rbtnCheque;
		...
		private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
		{
			try
			{
				this.strHeading = "RECEIPT REPORT";
		...
		public void FillCashBankAccountCombo()
		{
			try
			{
				...
				dataTable = (!this.rbtnCash.Checked ? accountLedgerSP.AccountLedgerViewUnderBank() : accountLedgerSP.AccountLedgerViewUnderCash());
				this.cmbSearch.DataSource = dataTable;
				this.cmbSearch.DisplayMember = dataTable.Columns[1].ToString();
				this.cmbSearch.ValueMember = dataTable.Columns[0].ToString();
			}
			catch (Exception exception1)
			{
				Exception exception = exception1;
		...
		public void FillRegister()
		{
			try
			{
				...
				if (this.rbtnAll.Checked)
				{
					...
					this.lblSearchfor.Enabled = false;
					this.cmbSearch.SelectedIndex = -1;
				}
				else if (!this.rbtnCash.Checked)
				{
					str = "By Cheque";
					this.cmbSearch.Enabled = true;
					this.lblSearchfor.Enabled = true;
				}
				else
				{
					str = "By Cash";
				...
				{
					dataTable1 = this.mastersp.RceiptMasterViewAllByCondition(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), str);
				}
				else
				{
					dataTable1 = (!(this.cmbSearch.Text != "All") ? this.mastersp.RceiptMasterViewAllByCondition(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), str) : this.mastersp.RceiptMasterViewAllByConditionForReport(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), str, this.cmbSearch.SelectedValue.ToString()));
				}
				int num = 0;
				foreach (DataRow row in dataTable1.Rows)
				{
					this.dgvReport.Rows.Add();
					lightSkyBlue++;
					this.dgvReport.Rows[lightSkyBlue].Cells[0].Value = num + 1;
					this.dgvReport.Rows[lightSkyBlue].Cells[1].Value = row.ItemArray[0].ToString();
					this.dgvReport.Rows[lightSkyBlue].Cells[2].Value = row.ItemArray[2].ToString();
					...
					this.dgvReport.Rows[lightSkyBlue].Cells[4].Value = row.ItemArray[5].ToString();
					num++;
				}
				this.dgvReport.Focus();
			}
			catch (Exception exception1)
			{
				Exception exception = exception1;
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptReceipt));
			...
			this.rbtnCheque = new RadioButton();
			...
			this.label2.Location = new Point(168, 19);
			...
			this.groupBox1.Controls.Add(this.rbtnCheque);
			...
			this.dtpTo.Location = new Point(200, 13);
			...
			this.rbtnCheque.BackColor = Color.Transparent;
			this.rbtnCheque.Location = new Point(592, 14);
			this.rbtnCheque.Name = "rbtnCheque";
			this.rbtnCheque.Size = new System.Drawing.Size(77, 17);
			this.rbtnCheque.TabIndex = 24;
			this.rbtnCheque.TabStop = true;
			this.rbtnCheque.Text = "By Cheque";
			this.rbtnCheque.UseVisualStyleBackColor = false;
			this.rbtnCheque.CheckedChanged += new EventHandler(this.rbtnCheque_CheckedChanged);
			this.rbtnCash.AutoSize = true;
			this.rbtnCash.BackColor = Color.Transparent;
			this.rbtnCash.Location = new Point(466, 15);
			this.rbtnCash.Name = "rbtnCash";
			this.rbtnCash.Size = new System.Drawing.Size(64, 17);
			this.rbtnCash.TabIndex = 22;
			...
			this.rbtnAll.Location = new Point(358, 17);
			...
			this.groupBox2.Controls.Add(this.lblSearchfor);
			...
			ComboBox.ObjectCollection objectCollections = this.cmbSearch.Items;
			objArray = new object[] { "All", "Department Wise", "Course Stream Wise" };
			objectCollections.AddRange(objArray);
			this.cmbSearch.Location = new Point(84, 15);
			...
			this.cmbSearch.KeyDown += new KeyEventHandler(this.dtpFrom_KeyDown);
			this.lblSearchfor.AutoSize = true;
			this.lblSearchfor.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f, FontStyle.Regular, GraphicsUnit.Point, 0);
			this.lblSearchfor.Location = new Point(6, 16);
			this.lblSearchfor.Name = "lblSearchfor";
			this.lblSearchfor.Size = new System.Drawing.Size(62, 13);
			this.lblSearchfor.TabIndex = 19;
			...
			base.Name = "rptReceipt";
			base.StartPosition = FormStartPosition.CenterScreen;
			base.WindowState = FormWindowState.Maximized;
			base.KeyDown += new KeyEventHandler(this.rptReceipt_KeyDown);
			base.Load += new EventHandler(this.rptReceipt_Load);
		...
		private void rptReceipt_KeyDown(object sender, KeyEventArgs e)
		{
			try
			{
