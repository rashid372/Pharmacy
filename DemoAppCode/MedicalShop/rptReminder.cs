...
namespace MedicalShop
{
	public class rptReminder : Form
	{
		...
		private void btnClear_Click(object sender, EventArgs e)
		{
			try
			{
				this.rptReminder_Load(sender, e);
			}
		...
		private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
		{
			try
			{
				this.strHeading = "REMINDER REPORT";
		...
		private void dgvReportFill()
		{
			try
			{
				DataTable dataTable = new DataTable();
				dataTable = this.ReminderSP.ReminderViewBetweenDates(DateTime.Parse(this.dtpFromDate.Text), DateTime.Parse(this.dtpToDate.Text));
				foreach (DataRow row in dataTable.Rows)
				{
					...
					DataGridViewCell str = this.dgvReport[2, this.dgvReport.Rows.Count - 1];
					dateTime = DateTime.Parse(row.ItemArray[2].ToString());
					str.Value = dateTime.ToString("dd-MMM-yyyy");
					string str1 = row.ItemArray[3].ToString();
					...
					if (!(str2 == " , "))
					{
						...
						string str3 = str2.Substring(0, length - 2);
						this.dgvReport[3, this.dgvReport.Rows.Count - 1].Value = str3;
					}
					else
					{
						this.dgvReport[3, this.dgvReport.Rows.Count - 1].Value = "";
					}
				}
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptReminder));
			...
			this.cmbExportType.KeyDown += new KeyEventHandler(this.dtpFromDate_KeyDown);
			...
			this.label2.Location = new Point(164, 21);
			...
			this.groupBox1.Location = new Point(16, 166);
			...
			this.dtpToDate.Location = new Point(196, 17);
			...
			this.dtpFromDate.Location = new Point(45, 17);
			...
			base.Name = "rptReminder";
			base.StartPosition = FormStartPosition.CenterScreen;
			base.WindowState = FormWindowState.Maximized;
			base.KeyPress += new KeyPressEventHandler(this.rptReminder_KeyPress);
			base.Load += new EventHandler(this.rptReminder_Load);
		...
		private void LoadGridColumns()
		{
			try
			{
				...
				this.dgvReport.Columns.Add("Reminder Date", "Reminder Date");
				...
				this.dgvReport[2, this.dgvReport.Rows.Count - 1].Value = "Reminder Date";
				this.dgvReport[3, this.dgvReport.Rows.Count - 1].Value = "Description";
		...
		private void rptReminder_KeyPress(object sender, KeyPressEventArgs e)
		{
			try
			{
				if (e.KeyChar == '\u001B')
		...
		private void rptReminder_Load(object sender, EventArgs e)
		{
			try
			{
				this.dgvReport.Rows.Clear();
