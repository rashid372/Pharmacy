...
namespace MedicalShop
{
	public class rtpSalesMan : Form
	{
		...
		private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
		{
			try
			{
				this.strHeading = "SALES MAN REPORT";
		...
		public void dgvReportFill()
		{
			...
			try
			{
				...
				foreach (DataRow row in this.SalesManSP.SalesManViewAllExceptNA().Rows)
				{
					if (this.rbtnAll.Checked)
					{
						...
						this.dgvReport[3, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[4].ToString();
						this.dgvReport[4, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[5].ToString();
						this.dgvReport[5, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[6].ToString();
						this.dgvReport[6, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[10].ToString();
						DataGridViewCell item = this.dgvReport[7, this.dgvReport.Rows.Count - 1];
						dateTime = DateTime.Parse(row.ItemArray[8].ToString());
						item.Value = dateTime.ToShortDateString();
						if (!(DateTime.Parse(row.ItemArray[9].ToString()).ToShortDateString() != DateTime.Parse("01/01/1753").ToShortDateString()))
						{
							this.dgvReport[8, this.dgvReport.Rows.Count - 1].Value = "";
						}
						else
						{
							DataGridViewCell shortDateString = this.dgvReport[8, this.dgvReport.Rows.Count - 1];
							dateTime = DateTime.Parse(row.ItemArray[9].ToString());
							shortDateString.Value = dateTime.ToShortDateString();
						}
					}
					else if (this.rbtnActive.Checked)
					{
						if (row.ItemArray[11].ToString().ToLower() == "true")
						{
							this.dgvReport.Rows.Add();
							this.dgvReport[0, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[0].ToString();
							this.dgvReport[1, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[1].ToString();
							...
							this.dgvReport[5, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[6].ToString();
							this.dgvReport[6, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[10].ToString();
							DataGridViewCell dataGridViewCell = this.dgvReport[7, this.dgvReport.Rows.Count - 1];
							dateTime = DateTime.Parse(row.ItemArray[8].ToString());
							dataGridViewCell.Value = dateTime.ToShortDateString();
							if (!(DateTime.Parse(row.ItemArray[9].ToString()).ToShortDateString() != DateTime.Parse("01/01/1753").ToShortDateString()))
							{
								this.dgvReport[8, this.dgvReport.Rows.Count - 1].Value = "";
							}
							...
							{
								DataGridViewCell item1 = this.dgvReport[8, this.dgvReport.Rows.Count - 1];
								dateTime = DateTime.Parse(row.ItemArray[9].ToString());
								item1.Value = dateTime.ToShortDateString();
							}
						}
					}
					else if (this.rbtnInActive.Checked)
					{
						if (row.ItemArray[11].ToString().ToLower() == "false")
						{
							this.dgvReport.Rows.Add();
							this.dgvReport[0, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[0].ToString();
							this.dgvReport[1, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[1].ToString();
							...
							this.dgvReport[5, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[6].ToString();
							this.dgvReport[6, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[10].ToString();
							DataGridViewCell shortDateString1 = this.dgvReport[7, this.dgvReport.Rows.Count - 1];
							dateTime = DateTime.Parse(row.ItemArray[8].ToString());
							shortDateString1.Value = dateTime.ToShortDateString();
							DataGridViewCell dataGridViewCell1 = this.dgvReport[8, this.dgvReport.Rows.Count - 1];
							dateTime = DateTime.Parse(row.ItemArray[9].ToString());
							dataGridViewCell1.Value = dateTime.ToShortDateString();
						}
					}
				}
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rtpSalesMan));
			...
			this.rbtnInActive = new RadioButton();
			this.rbtnActive = new RadioButton();
			...
			this.rbtnInActive.BackColor = Color.Transparent;
			this.rbtnInActive.Location = new Point(188, 15);
			this.rbtnInActive.Name = "rbtnInActive";
			this.rbtnInActive.Size = new System.Drawing.Size(63, 17);
			this.rbtnInActive.TabIndex = 24;
			this.rbtnInActive.TabStop = true;
			this.rbtnInActive.Text = "Inactive";
			this.rbtnInActive.UseVisualStyleBackColor = false;
			this.rbtnInActive.CheckedChanged += new EventHandler(this.rbtnInActive_CheckedChanged);
			this.rbtnActive.AutoSize = true;
			this.rbtnActive.BackColor = Color.Transparent;
			this.rbtnActive.Location = new Point(88, 17);
			...
			this.rbtnActive.CheckedChanged += new EventHandler(this.rbtnActive_CheckedChanged);
			this.rbtnAll.AutoSize = true;
			this.rbtnAll.BackColor = Color.Transparent;
			this.rbtnAll.Location = new Point(6, 16);
			...
			base.Name = "rtpSalesMan";
			base.StartPosition = FormStartPosition.CenterScreen;
			base.WindowState = FormWindowState.Maximized;
			base.KeyPress += new KeyPressEventHandler(this.rtpSalesMan_KeyPress);
		...
		public void LoadGridColumns()
		{
			try
			{
				...
				this.dgvReport.Columns.Add("Sales Man Name", "Sales Man Name");
				this.dgvReport.Columns.Add("Address", "Address");
				this.dgvReport.Columns.Add("Phone", "Phone");
				this.dgvReport.Columns.Add("Mobile", "Mobile");
				this.dgvReport.Columns.Add("Email", "Email");
				this.dgvReport.Columns.Add("Qualification", "Qualification");
				this.dgvReport.Columns.Add("Date of Joining", "Date of Joining");
				this.dgvReport.Columns.Add("Date of Termination", "Date of Termination");
				this.dgvReport.Columns[0].Width = 50;
				this.dgvReport.Rows.Add(1);
				this.dgvReport.Rows[0].Frozen = true;
				this.dgvReport[0, this.dgvReport.Rows.Count - 1].Value = "Code";
				this.dgvReport[1, this.dgvReport.Rows.Count - 1].Value = "Sales Man Name";
				this.dgvReport[2, this.dgvReport.Rows.Count - 1].Value = "Address";
				this.dgvReport[3, this.dgvReport.Rows.Count - 1].Value = "Phone";
				this.dgvReport[4, this.dgvReport.Rows.Count - 1].Value = "Mobile";
				this.dgvReport[5, this.dgvReport.Rows.Count - 1].Value = "Email";
				this.dgvReport[6, this.dgvReport.Rows.Count - 1].Value = "Qualification";
				this.dgvReport[7, this.dgvReport.Rows.Count - 1].Value = "Date of Joining";
				this.dgvReport[8, this.dgvReport.Rows.Count - 1].Value = "Date of Termination";
		...
		private void rtpSalesMan_KeyPress(object sender, KeyPressEventArgs e)
		{
			try
			{
				if (e.KeyChar == '\u001B')
