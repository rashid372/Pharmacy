...
{
	public class frmPaymentRegister : Form
	{
		...
		public void CallPaymentVocuher()
		{
			if (this.dgvRegister.CurrentRow != null)
			{
				...
				_frmPayment.DoWhenComingFromRegister(this, this.dgvRegister.CurrentRow.Cells[0].Value.ToString());
				base.Enabled = false;
			}
		}
		...
		public void FillRegister()
		{
			...
			DataTable dataTable = this.mastersp.PaymentMasterViewAllByCondition(DateTime.Parse(this.dtpFromDate.Text), DateTime.Parse(this.dtpToDate.Text), str);
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmPaymentRegister));
			...
			this.btnReset.Location = new Point(269, 295);
			this.btnReset.Name = "btnReset";
			this.btnReset.Size = new System.Drawing.Size(107, 23);
			this.btnReset.TabIndex = 9;
			this.btnReset.Text = "&Refresh";
			this.btnReset.UseVisualStyleBackColor = false;
			this.btnReset.Click += new EventHandler(this.frmPaymentRegister_Load);
			...
			this.Ledger.HeaderText = "Paid To";
			...
			this.txtSearch.Location = new Point(320, 36);
			...
			this.rbtnChecque.Location = new Point(298, 12);
			...
			this.rbtnCash.Location = new Point(228, 12);
			...
			this.rbtnAll.Location = new Point(186, 12);
			...
			this.label1.Text = "Payment Register";
			...
			base.Name = "frmPaymentRegister";
			base.Padding = new System.Windows.Forms.Padding(7);
			base.StartPosition = FormStartPosition.CenterScreen;
			this.Text = "Payment Register";
			base.Load += new EventHandler(this.frmPaymentRegister_Load);
