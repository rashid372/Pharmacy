...
{
	public class rptAccountGroup : Form
	{
		...
		private void btnClear_Click(object sender, EventArgs e)
		{
			try
			{
				this.rptAccountGroup_Load(sender, e);
			}
		...
		private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
		{
			try
			{
				this.strHeading = "ACCOUNT GROUP REPORT";
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptAccountGroup));
			...
			this.rbtnNonBuiltIn.TabIndex = 1536;
			...
			this.rbtnBuiltIn.TabIndex = 1534;
			...
			base.Name = "rptAccountGroup";
			base.StartPosition = FormStartPosition.CenterScreen;
			base.WindowState = FormWindowState.Maximized;
			base.KeyPress += new KeyPressEventHandler(this.rptAccountGroup_KeyPress);
			base.Load += new EventHandler(this.rptAccountGroup_Load);
		...
		private void rptAccountGroup_KeyPress(object sender, KeyPressEventArgs e)
		{
			try
			{
				if (e.KeyChar == '\u001B')
		...
		private void rptAccountGroup_Load(object sender, EventArgs e)
		{
			try
			{
