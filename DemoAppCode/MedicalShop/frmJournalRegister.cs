...
{
	public class frmJournalRegister : Form
	{
		...
		public void CallJournalVocuher()
		{
			if (this.dgvRegister.CurrentRow != null)
			{
				...
				_frmJournalEntry.DoWhenComingFromRegister(this, this.dgvRegister.CurrentRow.Cells[0].Value.ToString());
				base.Enabled = false;
			}
		}
		...
		public void DoWhenComingFromJounal()
		{
			base.Enabled = true;
			this.FillRegister();
		...
		{
			DataTable dataTable = this.mastersp.JournalMasterViewAllBetweenDate(DateTime.Parse(this.dtpFromDate.Text), DateTime.Parse(this.dtpToDate.Text));
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmJournalRegister));
			...
			this.btnClose.Location = new Point(387, 295);
			...
			this.btnRefresh.Location = new Point(274, 295);
			this.btnRefresh.Name = "btnRefresh";
			this.btnRefresh.Size = new System.Drawing.Size(107, 23);
			this.btnRefresh.TabIndex = 9;
			this.btnRefresh.Text = "&Refresh";
			this.btnRefresh.UseVisualStyleBackColor = false;
			this.btnRefresh.Click += new EventHandler(this.frmJournalRegister_Load);
			...
			this.btnView.Location = new Point(161, 295);
			...
			DataGridViewColumn[] voucherNo = new DataGridViewColumn[] { this.VoucherNo, this.Date, this.Debit, this.Credit };
			columns.AddRange(voucherNo);
			this.dgvRegister.GridColor = Color.WhiteSmoke;
			this.dgvRegister.Location = new Point(8, 72);
			...
			this.dgvRegister.Size = new System.Drawing.Size(451, 169);
			...
			this.VoucherNo.SortMode = DataGridViewColumnSortMode.Programmatic;
			...
			this.label1.Text = "Journal Register";
			...
			base.Name = "frmJournalRegister";
			base.Padding = new System.Windows.Forms.Padding(7);
			base.StartPosition = FormStartPosition.CenterScreen;
			this.Text = "Journal Register";
			base.Load += new EventHandler(this.frmJournalRegister_Load);
