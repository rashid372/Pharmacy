...
{
	public class rptStockAndSale : Form
	{
		...
		private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
		{
			try
			{
				this.strHeading = "STOCK AND SALE REPORT";
		...
		public void FillGrid()
		{
			try
			{
				...
				dataTable = productSP.StockAndSaleReport(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text));
				int str = 1;
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptStockAndSale));
			...
			this.label5.Text = "Stock And Sale";
		...
		public void LoadGridColumns()
		{
			try
			{
				...
				this.dgvReport.Columns.Add("Inward Qty", "Opening Stock");
				this.dgvReport.Columns.Add("Inward Qty", "Inward Qty");
				this.dgvReport.Columns.Add("Outward Qty", "Outward Qty");
				this.dgvReport.Columns.Add("Closing Stock", "Closing Stock");
				...
				this.dgvReport[3, this.dgvReport.Rows.Count - 1].Value = "Opening Stock";
				this.dgvReport[4, this.dgvReport.Rows.Count - 1].Value = "Inward Qty";
				this.dgvReport[5, this.dgvReport.Rows.Count - 1].Value = "Outward Qty";
				this.dgvReport[6, this.dgvReport.Rows.Count - 1].Value = "Closing Stock";
