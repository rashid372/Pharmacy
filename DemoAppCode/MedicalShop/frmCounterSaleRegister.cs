...
{
	public class frmCounterSaleRegister : Form
	{
		...
		public void CallSalesInvoice()
		{
			if (this.dgvRegister.CurrentRow != null)
			{
				...
				_frmCounterSale.DoWhenComingFromRegister(this, this.dgvRegister.CurrentRow.Cells[0].Value.ToString());
				base.Enabled = false;
			}
		}
		...
		public void DoWhenComingFromCounterSale(bool isInEditMode)
		{
			if (!isInEditMode)
			{
				base.Close();
		...
		{
			DataTable dataTable = this.mastersp.CounterSaleMasterViewAllForRegister(DateTime.Parse(this.dtpFromDate.Text), DateTime.Parse(this.dtpToDate.Text));
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmCounterSaleRegister));
			...
			this.label1.Text = "Counter Sale Register";
			...
			base.Name = "frmCounterSaleRegister";
			base.Padding = new System.Windows.Forms.Padding(7);
			base.StartPosition = FormStartPosition.CenterScreen;
			this.Text = "Counter Sale Register";
