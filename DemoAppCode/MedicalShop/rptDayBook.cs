...
namespace MedicalShop
{
	public class rptDayBook : Form
	{
		...
		public void FillGrid()
		{
			...
			dataTable = accountLedgerSP.Daybook(DateTime.Parse(this.dtpFrom.Text));
			int str = 1;
		...
		private void FillGridAccordingToSearch()
		{
			...
			{
				int num = 0;
				if (this.cmbSearchBy.Text == "Voucher Type")
				{
					num = 1;
				}
		...
		private void FillSerachCombo()
		{
			...
			else if (!(this.cmbSearchBy.Text == "Voucher Type"))
			{
			...
			else
			{
				...
				dataRow[dataColumn] = "Purchase Invoice";
				dataTable1.Rows.Add(dataRow);
				dataRow = dataTable1.NewRow();
				dataRow[dataColumn] = "Purchase Return";
				dataTable1.Rows.Add(dataRow);
				dataRow = dataTable1.NewRow();
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptDayBook));
			...
			object[] objArray = new object[] { "All", "Account Ledger", "Voucher Type" };
		...
		public void LoadGridColumns()
		{
			try
			{
				...
				this.dgvReport.Columns.Add("Amount", "Amount");
				...
				this.dgvReport[1, this.dgvReport.Rows.Count - 1].Value = "Voucher Type";
				this.dgvReport[2, this.dgvReport.Rows.Count - 1].Value = "Voucher No";
				this.dgvReport[3, this.dgvReport.Rows.Count - 1].Value = "Account Ledger";
				this.dgvReport[4, this.dgvReport.Rows.Count - 1].Value = "Amount";
