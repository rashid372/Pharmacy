...
{
	public class frmSelectCompany : Form
	{
		...
		public void FillFinacialYearGrid()
		{
			...
			dataTable = (new CompanySP()).CompanyViewAll();
			...
			foreach (DataRow row in dataTable.Rows)
			{
                ...
                this.dgvFinancial.Rows[str].Cells[1].Value = row.ItemArray[1].ToString();
		...
		private void InitializeComponent()
		{
			...
			this.FinacialYear.HeaderText = "Select Company";
			this.FinacialYear.Name = "SelectCompany";
