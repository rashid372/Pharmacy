...
{
	public class frmPurchaseReturnRegister : Form
	{
		...
		private void btnView_Click(object sender, EventArgs e)
		{
			try
			{
				this.CallPurchaseReturnInvoice();
			}
			catch (Exception exception1)
			{
				Exception exception = exception1;
		...
		public void CallPurchaseReturnInvoice()
		{
			if (this.dgvRegister.CurrentRow != null)
			{
				...
				_frmPurchaseReturn.DoWhenComingFromRegister(this, this.dgvRegister.CurrentRow.Cells[0].Value.ToString());
				base.Enabled = false;
			}
		}
		...
		{
			DataTable dataTable = this.mastersp.PurchaseReturnMasterViewAllForRegisters(DateTime.Parse(this.dtpFromDate.Text), DateTime.Parse(this.dtpToDate.Text));
			...
			foreach (DataRow row in dataTable.Rows)
			{
				...
				this.dgvRegister.Rows[str].Cells[3].Value = row.ItemArray[3].ToString();
				str++;
			}
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmPurchaseReturnRegister));
			...
			this.btnRefresh.Click += new EventHandler(this.frmPurchaseReturnRegister_Load);
			...
			DataGridViewColumn[] voucherNo = new DataGridViewColumn[] { this.VoucherNo, this.InvoiceNo, this.Ledger, this.Date };
			...
			this.VoucherNo.FillWeight = 65.65144f;
			...
			this.label4.Location = new Point(207, 40);
			...
			this.label1.Text = "Purchase Return  Register";
			...
			base.Name = "frmPurchaseReturnRegister";
			base.Padding = new System.Windows.Forms.Padding(7);
			base.StartPosition = FormStartPosition.CenterScreen;
			this.Text = "Purchase Return Register";
			base.Load += new EventHandler(this.frmPurchaseReturnRegister_Load);
