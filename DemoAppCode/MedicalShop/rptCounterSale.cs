...
{
	public class rptCounterSale : Form
	{
		...
		private void cmbSearchFor_SelectedIndexChanged(object sender, EventArgs e)
		{
			try
			{
				...
				if (this.cmbSearchFor.Text != "")
				{
					...
					{
						this.cmbSearchBy.Visible = true;
						dataTable = counterSaleMasterSP.CounterSaleMasterViewAll();
						this.cmbSearchBy.DataSource = dataTable;
						this.cmbSearchBy.ValueMember = "Id";
		...
		public void fillGrid()
		{
			try
			{
				...
				if (this.cmbSearchFor.Text == "All")
				{
					dataTable = this.mastersp.CounterReportForAll(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text));
				}
				else if (this.cmbSearchFor.Text == "Generic Name")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.CounterReportForGenericName(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Product")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.CounterReportForProduct(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Product Group")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.CounterReportForProductGroup(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Voucher No")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.CounterReportForVoucherNo(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				totalAmount = 0;
			...
			this.lblTotal.Text = totalAmount.ToString();
		}

		private void InitializeComponent()
		{
			this.components = new System.ComponentModel.Container();
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptCounterSale));
			...
			this.groupBox4.Location = new Point(752, 152);
			...
			this.groupBox1.Location = new Point(12, 133);
			...
			this.cmbSearchBy.Location = new Point(264, 17);
			...
			objArray = new object[] { "All", "Generic Name", "Product", "Product Group", "Voucher No" };
