...
{
	public class rptPurchaseReturn : Form
	{
		...
		private PurchaseReturnMasterSP mastersp = new PurchaseReturnMasterSP();
		...
		private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
		{
			try
			{
				this.strHeading = "PURCHASE RETURN REPORT";
		...
		private void cmbSearchFor_SelectedIndexChanged(object sender, EventArgs e)
		{
			try
			{
				...
				if (this.cmbSearchFor.Text != "")
				{
					...
					{
						this.cmbSearchBy.Visible = true;
						dataTable = purchaseReturnMasterSP.PurchaseReturnMasterViewAll();
						if (dataTable.Rows.Count > 0)
						{
							this.cmbSearchBy.DataSource = dataTable;
							this.cmbSearchBy.ValueMember = "Id";
		...
		public void fillGrid()
		{
			try
			{
				...
				if (this.cmbSearchFor.Text == "All")
				{
					dataTable = this.mastersp.PurchaseReturnRportForAll(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text));
				}
				else if (this.cmbSearchFor.Text == "Generic Name")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.PurchaseReturnRportForGenericName(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Product")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.PurchaseReturnRportForProduct(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Invoice No")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.PurchaseReturnRportForInvoice(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Product Group")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.PurchaseReturnRportForProdcutGroup(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
				else if (this.cmbSearchFor.Text == "Voucher No")
				{
					if (this.cmbSearchBy.Text != "")
					{
						dataTable = this.mastersp.PurchaseReturnRportForVoucherNo(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), this.cmbSearchBy.SelectedValue.ToString());
					}
				}
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptPurchaseReturn));
			...
			this.groupBox1.Location = new Point(8, 130);
			...
			this.groupBox2.Location = new Point(7, 178);
			...
			this.cmbSearchBy.Location = new Point(251, 13);
			...
			this.cmbSearchFor.Location = new Point(70, 14);
