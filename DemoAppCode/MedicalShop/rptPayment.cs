...
namespace MedicalShop
{
	public class rptPayment : Form
	{
		...
		private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
		{
			try
			{
				this.strHeading = "PAYMENT REPORT";
		...
		public void FillRegister()
		{
			try
			{
				...
				{
					dataTable1 = this.mastersp.PaymentMasterViewAllByCondition(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), str);
				}
				else
				{
					dataTable1 = (!(this.cmbSearch.Text != "All") ? this.mastersp.PaymentMasterViewAllByCondition(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), str) : this.mastersp.PaymentMasterViewAllByConditionForReport(DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text), str, this.cmbSearch.SelectedValue.ToString()));
				}
				int num = 0;
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptPayment));
			...
			this.groupBox4.Location = new Point(752, 145);
			...
			this.groupBox1.Location = new Point(8, 128);
			...
			this.dtpFrom.Location = new Point(45, 14);
			...
			this.rbtnCheque.Location = new Point(627, 14);
			...
			this.rbtnCash.Location = new Point(488, 15);
			...
			this.cmbSearch.Location = new Point(92, 14);
			...
			base.Name = "rptPayment";
			base.StartPosition = FormStartPosition.CenterScreen;
			base.WindowState = FormWindowState.Maximized;
			base.KeyDown += new KeyEventHandler(this.rptPayment_KeyDown);
			base.Load += new EventHandler(this.rptPayment_Load);
		...
		private void rptPayment_KeyDown(object sender, KeyEventArgs e)
		{
			try
			{
