	...
	public class rptUser : Form
	{
		...
		public void dgvReportFill()
		{
			...
			try
			{
				...
				foreach (DataRow row in this.UserSP.UserViewAll().Rows)
				{
					if (this.rbtnAll.Checked)
					{
						...
						str = row.ItemArray[4].ToString();
						strArrays = Regex.Split(str, "\r\n");
						str1 = "";
						...
						{
							length = str1.Length;
							str2 = str1.Substring(0, length - 2);
					...
					{
						if (row.ItemArray[3].ToString().ToLower() == "true")
						{
							this.dgvReport.Rows.Add();
							this.dgvReport[0, this.dgvReport.Rows.Count - 1].Value = this.dgvReport.RowCount - 1;
							this.dgvReport[1, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[1].ToString();
					...
					else if (this.rbtnBlocked.Checked)
					{
						if (row.ItemArray[3].ToString().ToLower() == "false")
						{
							this.dgvReport.Rows.Add();
							this.dgvReport[0, this.dgvReport.Rows.Count - 1].Value = this.dgvReport.RowCount - 1;
							this.dgvReport[1, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[1].ToString();
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptUser));
			...
			this.rbtnBlocked = new RadioButton();
			...
			this.groupBox1.Controls.Add(this.rbtnBlocked);
			this.groupBox1.Controls.Add(this.rbtnActive);
			this.groupBox1.Controls.Add(this.rbtnAll);
			this.groupBox1.Location = new Point(18, 166);
			this.groupBox1.Name = "groupBox1";
			this.groupBox1.Size = new System.Drawing.Size(734, 42);
			this.groupBox1.TabIndex = 20;
			this.groupBox1.TabStop = false;
			this.rbtnBlocked.AutoSize = true;
			this.rbtnBlocked.BackColor = Color.Transparent;
			this.rbtnBlocked.Location = new Point(180, 18);
			this.rbtnBlocked.Name = "rbtnBlocked";
			this.rbtnBlocked.Size = new System.Drawing.Size(64, 17);
			this.rbtnBlocked.TabIndex = 24;
			this.rbtnBlocked.TabStop = true;
			this.rbtnBlocked.Text = "Blocked";
			this.rbtnBlocked.UseVisualStyleBackColor = false;
			this.rbtnBlocked.CheckedChanged += new EventHandler(this.rbtnBlocked_CheckedChanged);
			...
			base.KeyPress += new KeyPressEventHandler(this.rtpUser_KeyPress);
			base.Load += new EventHandler(this.rptUser_Load);
		...
		public void LoadGridColumns()
		{
			try
			{
				...
				this.dgvReport.Columns.Add("User Name", "User Name");
				...
				this.dgvReport[1, this.dgvReport.Rows.Count - 1].Value = "User Name";
		...
		private void rbtnBlocked_CheckedChanged(object sender, EventArgs e)
		{
			try
			{
				this.LoadGridColumns();
		...
		private void rptUser_Load(object sender, EventArgs e)
		{
			try
			{
		...
		private void rtpUser_KeyPress(object sender, KeyPressEventArgs e)
		{
			try
			{
				if (e.KeyChar == '\u001B')
