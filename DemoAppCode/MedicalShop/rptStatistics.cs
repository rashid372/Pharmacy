...
{
	public class rptStatistics : Form
	{
		...
		private RadioButton rbtnUnused;

		private RadioButton rbtnSlowMoving;

		private RadioButton rbtnFastMoving;
		...
		{
			this.rptStatistics_Load(sender, e);
		}
		...
		private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
		{
			try
			{
				if (this.rbtnFastMoving.Checked)
				{
					this.strHeading = "PRODUCT STATISTICS REPORT (FAST MOVING)";
				}
				else if (this.rbtnSlowMoving.Checked)
				{
					this.strHeading = "PRODUCT STATISTICS REPORT (SLOW MOVING)";
				}
				else if (this.rbtnUnused.Checked)
				{
					this.strHeading = "PRODUCT STATISTICS REPORT (UNUSED)";
				}
		...
		public void FillGrid()
		{
			try
			{
				...
				if (this.rbtnFastMoving.Checked)
				{
					dataTable = productSP.StatisticsReport("Fast Moving", DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text));
					this.dgvReport.Columns[4].Visible = true;
				}
				else if (!this.rbtnSlowMoving.Checked)
				{
					dataTable = productSP.StatisticsReport("unused", DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text));
					this.dgvReport.Columns[4].Visible = false;
				}
				else
				{
					dataTable = productSP.StatisticsReport("Slow Moving", DateTime.Parse(this.dtpFrom.Text), DateTime.Parse(this.dtpTo.Text));
					this.dgvReport.Columns[4].Visible = true;
				}
				int str = 1;
		...
		private void FillGridAcordingTosearch()
		{
			int i;
			try
			{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptStatistics));
			...
			this.rbtnUnused = new RadioButton();
			this.rbtnSlowMoving = new RadioButton();
			this.rbtnFastMoving = new RadioButton();
			...
			this.label5.Text = "Product Statistics";
			...
			this.cmbSearchFor.Location = new Point(331, 15);
			...
			this.cmbSearchBy.Location = new Point(124, 17);
			...
			this.lblSearc.Location = new Point(44, 20);
			...
			this.rbtnUnused.BackColor = Color.Transparent;
			this.rbtnUnused.Location = new Point(632, 16);
			this.rbtnUnused.Name = "rbtnUnused";
			this.rbtnUnused.Size = new System.Drawing.Size(65, 17);
			this.rbtnUnused.TabIndex = 27;
			this.rbtnUnused.TabStop = true;
			this.rbtnUnused.Text = "Unused ";
			this.rbtnUnused.UseVisualStyleBackColor = false;
			this.rbtnUnused.CheckedChanged += new EventHandler(this.cmbSearch_SelectedIndexChanged);
			this.rbtnSlowMoving.AutoSize = true;
			this.rbtnSlowMoving.BackColor = Color.Transparent;
			this.rbtnSlowMoving.Location = new Point(493, 17);
			this.rbtnSlowMoving.Name = "rbtnSlowMoving";
			this.rbtnSlowMoving.Size = new System.Drawing.Size(86, 17);
			this.rbtnSlowMoving.TabIndex = 25;
			this.rbtnSlowMoving.TabStop = true;
			this.rbtnSlowMoving.Text = "Slow Moving";
			this.rbtnSlowMoving.UseVisualStyleBackColor = false;
			this.rbtnSlowMoving.CheckedChanged += new EventHandler(this.cmbSearch_SelectedIndexChanged);
			this.rbtnFastMoving.AutoSize = true;
			this.rbtnFastMoving.BackColor = Color.Transparent;
			this.rbtnFastMoving.Location = new Point(363, 19);
			this.rbtnFastMoving.Name = "rbtnFastMoving";
			this.rbtnFastMoving.Size = new System.Drawing.Size(83, 17);
			this.rbtnFastMoving.TabIndex = 26;
			this.rbtnFastMoving.TabStop = true;
			this.rbtnFastMoving.Text = "Fast Moving";
			this.rbtnFastMoving.UseVisualStyleBackColor = false;
			this.rbtnFastMoving.CheckedChanged += new EventHandler(this.cmbSearch_SelectedIndexChanged);
			this.groupBox1.BackColor = Color.Transparent;
			this.groupBox1.Controls.Add(this.rbtnUnused);
			this.groupBox1.Controls.Add(this.dtpTo);
			this.groupBox1.Controls.Add(this.rbtnSlowMoving);
			this.groupBox1.Controls.Add(this.dtpFrom);
			this.groupBox1.Controls.Add(this.rbtnFastMoving);
			this.groupBox1.Controls.Add(this.label2);
			this.groupBox1.Controls.Add(this.label1);
			this.groupBox1.Location = new Point(10, 130);
			...
			base.Name = "rptStatistics";
			base.StartPosition = FormStartPosition.CenterScreen;
			base.WindowState = FormWindowState.Maximized;
			base.KeyDown += new KeyEventHandler(this.rptStatistics_KeyDown);
			base.Load += new EventHandler(this.rptStatistics_Load);
		...
		public void LoadGridColumns()
		{
			try
			{
				...
				this.dgvReport.Columns.Add("Sold Qty", "Sold Qty");
				...
				this.dgvReport["Sold Qty", this.dgvReport.Rows.Count - 1].Value = "Sold Qty";
		...
		private void rptStatistics_KeyDown(object sender, KeyEventArgs e)
		{
			try
			{
		...
		private void rptStatistics_Load(object sender, EventArgs e)
		{
			try
			{
				...
				this.cmbSearchFor.Visible = false;
				this.rbtnFastMoving.Checked = true;
