	...
	public class rtpProduct : Form
	{
		...
		private void bwrk1_DoWork(object sender, DoWorkEventArgs e)
		{
			...
			catch (Exception exception1)
			{
				...
				MessageBox.Show(exception.Message, "Medical Shop", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
			}
		}
		...
		public void FillLowStockGrid()
		{
			...
			foreach (DataRow row in productSP.AllProductsStockForProductAvailibilitySearch().Rows)
			{
				this.dgvReport.Rows.Add();
				this.dgvReport[0, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[3].ToString();
				...
				this.dgvReport[5, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[5].ToString();
				this.dgvReport[6, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[6].ToString();
				this.dgvReport[7, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[7].ToString();
				this.dgvReport[8, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[8].ToString();
				this.dgvReport[9, this.dgvReport.Rows.Count - 1].Value = row.ItemArray[9].ToString();
			}
		}
		...
		private void FillLowStockGridAccordingToSearch()
		{
			...
			else
			{
				...
				{
					if (!this.dgvReport.Rows[i].Cells[num].Value.ToString().ToLower().StartsWith(this.cmbSearch.Text.ToLower()))
					{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rtpProduct));
			...
			this.btnClear.BackgroundImage = (Image)componentResourceManager.GetObject("btnClear.BackgroundImage");
			...
			this.btnExport.BackgroundImage = (Image)componentResourceManager.GetObject("btnExport.BackgroundImage");
			...
			this.groupBox2.Location = new Point(12, 165);
			this.groupBox2.Name = "groupBox2";
			this.groupBox2.Size = new System.Drawing.Size(734, 62);
			this.groupBox2.TabIndex = 21;
			this.groupBox2.TabStop = false;
			this.cbPrint.AutoSize = true;
			this.cbPrint.Location = new Point(515, 25);
			this.cbPrint.Name = "cbPrint";
			this.cbPrint.Size = new System.Drawing.Size(138, 17);
			this.cbPrint.TabIndex = 105;
			this.cbPrint.Text = "Available Products Only";
			this.cbPrint.UseVisualStyleBackColor = true;
			this.cmbSearch.DropDownStyle = ComboBoxStyle.DropDownList;
			this.cmbSearch.FormattingEnabled = true;
			this.cmbSearch.Location = new Point(293, 21);
			...
			this.cmbSearchBy.Location = new Point(86, 23);
			...
			this.lblSearc.Location = new Point(6, 26);
		...
		public void LoadGridColumns()
		{
			try
			{
				...
				this.dgvReport.Columns.Add("Stock Min. Level", "Stock Min. Level");
				this.dgvReport.Columns.Add("Shelf", "Shelf");
				this.dgvReport.Columns.Add("Group", "Group");
				this.dgvReport.Columns.Add("Manufacture", "Manufacture");
				...
				this.dgvReport.Columns[3].Width = 110;
				this.dgvReport.Rows.Add(1);
				this.dgvReport.Rows[0].Frozen = true;
				this.dgvReport[0, this.dgvReport.Rows.Count - 1].Value = "Code";
				this.dgvReport[1, this.dgvReport.Rows.Count - 1].Value = "Product";
				this.dgvReport[2, this.dgvReport.Rows.Count - 1].Value = "Current Stock";
				this.dgvReport[3, this.dgvReport.Rows.Count - 1].Value = "Stock Min. Level";
				this.dgvReport[4, this.dgvReport.Rows.Count - 1].Value = "Shelf";
				this.dgvReport[5, this.dgvReport.Rows.Count - 1].Value = "Group";
				this.dgvReport[6, this.dgvReport.Rows.Count - 1].Value = "Manufacture";
				this.dgvReport[7, this.dgvReport.Rows.Count - 1].Value = "Generic Name";
				this.dgvReport[8, this.dgvReport.Rows.Count - 1].Value = "Medicine For";
				this.dgvReport[9, this.dgvReport.Rows.Count - 1].Value = "Unit";
